...
local HttpService = game:GetService("HttpService")
local upgraderitemdata = game:HttpGet("https://raw.githubusercontent.com/slendercreeper/MinersHaven/main/wiki%20reference")
local upgraderalldata = HttpService:JSONDecode(upgraderitemdata)
local furnaceitemdata = game:HttpGet("https://raw.githubusercontent.com/slendercreeper/MinersHaven/main/wiki%20reference%20furnaces")
local furnacealldata = HttpService:JSONDecode(furnaceitemdata)
local mineitemdata = game:HttpGet("https://raw.githubusercontent.com/slendercreeper/MinersHaven/main/wiki%20reference%20mines")
